...
<!-- Mirrored from sellzy-preview.netlify.app/wishlist-style-v1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jun 2026 07:04:48 GMT -->
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <a class='active' href='wishlist-style-v1.html'>Shop - Wishlist Version 1</a
                    >
                  </li>
                  <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a class="active" href="#">Shop - Wishlist</a>
                      <ul>
                        <li>
                          <a class='active' href='wishlist-style-v1.html'>
                            Shop - Wishlist
                          </a>
                        </li>
                        <li>
          ...
          >
            ...
            <ul class="flex flex-col gap-y-1.5 pt-4">
              ...
              <li class="py-1.5 flex items-center gap-x-2">
                ...
                <a class='text-primary-lighter font-semibold hover:underline' href='wishlist-style-v1.html'>Wishlist</a
                >
              </li>
              <li class="py-1.5 flex items-center gap-x-2">
                <span class="inline-flex items-center"
    ...
    >
      <div class="container">
        <ul class="flex items-center justify-between footer-bottom-nav -mt-px">
          ...
          <li class="group">
            <a class='footer-bottom-nav-btn flex items-center flex-col gap-y-1 border-t-2 border-transparent text-sm leading-[22px] text-light-primary-text px-[9px] pt-2.5 pb-1 active' href='wishlist-style-v1.html'><span class="inline-flex items-center justify-center">
                <i
