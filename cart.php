...
<!-- Mirrored from sellzy-preview.netlify.app/cart-single-vendor by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jun 2026 07:04:49 GMT -->
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <a class='active' href='cart-single-vendor.html'>Shop - Cart</a
                    >
                  </li>
                  <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a class="active" href="#">Shop - Cart</a>
                      <ul>
                        <li>
                          <a class='active' href='cart-single-vendor.html'>
                            Shop - Cart
                          </a>
                        </li>
                        <li>
                ...
                <tbody>
                  <tr class="py-4">
                    <td data-title="Product " class="py-4 px-3 lg:px-4 product">
                      <div
                        class="flex items-end md:items-start gap-x-4 flex-col md:flex-row gap-y-4"
                      >
                        <div
                          class="product-thumbnail max-w-[120px] h-[120px] rounded-2xl bg-[#F4F3F5]"
                        >
                          <img
                            src="assets/images/ground-nuts-oil.png"
                            alt="vitamin-c"
                        ...
                        <div
                          class="flex flex-col gap-y-2 items-end md:items-start"
                        >
                          <a class='product-name text-light-primary-text font-semibold truncate hover:text-primary transition-colors duration-300' href='product-detail.php'>
                            Morning Brew Instant Coffee
                          </a>
                          <p
                            class="text-sm leading-[22px] font-normal text-light-secondary-text inline-flex items-center gap-x-2.5"
                          >
                            ...
                            <a
                              ...
                              ><i
                                class="hgi hgi-stroke hgi-edit-02 text-base leading-4"
                              ></i
                            ></a>
                          </p>
                          <p
                    ...
                    <td
                      data-title="Quantity "
                      class="capitalize py-4 px-3 lg:px-0 product-quantity"
                    >
                      <div
                        class="border border-gray-300 inline-flex items-center justify-center rounded-[80px] max-w-[108px] py-2.5 px-4"
                      >
                    ...
                    <td
                      ...
                      class="capitalize py-4 px-3 lg:px-0 product-total-price"
                    >
                      <p class="font-semibold text-light-primary-text">
                        $27.49
                      </p>
                    ...
                    <td
                      data-title="Action "
                      class="capitalize py-4 px-3 lg:px-4 product-actions"
                    >
                      <div
                        class="flex items-center justify-center gap-x-2 md:gap-x-6"
                      >
                        <button
                          class="inline-flex items-center justify-center product-add-to-favourite"
                        >
                          <i
                        ...
                        >
                          <i
                            class="hgi hgi-stroke hgi-delete-01 text-2xl leading-6 text-light-primary-text"
                          ></i>
                        </button>
                      </div>
                    </td>
    ...
    >
      <div class="container">
        ...
        <div class="pb-9 grid grid-cols-12 gap-6">
          <div
            class="md:col-span-12 col-span-12 xl:col-span-3 flex flex-col gap-y-6 wow animate__animated animate__fadeInUp"
            data-wow-delay=".2s"
          >
            <div>
              <a href='index.html'>
          ...
          <div
            class="md:col-span-6 col-span-12 xl:col-span-2 wow animate__animated animate__fadeInUp"
            data-wow-delay=".3s"
          >
            <h5
            ...
            <ul class="flex flex-col gap-y-1.5 pt-4">
              <li class="py-1.5 flex items-center gap-x-2">
                ...
                <a class='text-primary-lighter font-semibold hover:underline' href='about.html'>About Us</a
                >
              </li>
              <li class="py-1.5 flex items-center gap-x-2">
                <span class="inline-flex items-center"
          ...
          >
            ...
            <ul class="flex flex-col gap-y-1.5 pt-4">
              ...
              <li class="py-1.5 flex items-center gap-x-2">
                ...
                <a class='text-primary-lighter font-semibold hover:underline' href='vendor-account.html'>Become a Vendor</a
                >
              </li>
              <li class="py-1.5 flex items-center gap-x-2">
                <span class="inline-flex items-center"
                ...
                <a class='text-primary-lighter font-semibold hover:underline' href='wishlist.php'>Wishlist</a
                >
              </li>
              <li class="py-1.5 flex items-center gap-x-2">
                <span class="inline-flex items-center"
        ...
        <div
          class="text-center text-white bg-[url('images/bottom-border.html')] pt-[22px] bg-center pb-px bg-no-repeat wow animate__animated animate__fadeInUp"
          data-wow-delay=".2s"
        >
    ...
    >
      <div class="container">
        <ul class="flex items-center justify-between footer-bottom-nav -mt-px">
          ...
          <li class="group">
            <a class='footer-bottom-nav-btn flex items-center flex-col gap-y-1 border-t-2 border-transparent text-sm leading-[22px] text-light-primary-text px-[9px] pt-2.5 pb-1 active' href='cart-single-vendor.html'><span class="inline-flex items-center justify-center">
                <i
...
<!-- Mirrored from sellzy-preview.netlify.app/cart-single-vendor by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jun 2026 07:04:50 GMT -->
</html>
