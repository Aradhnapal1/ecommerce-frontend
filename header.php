                        ...
                        <div>
                            <ul id="dropdownMenu"
                                ...
                                <li class="py-[9px] group relative">
                                    <a href="#"
                                        class="flex items-center gap-x-2 relative text-light-primary-text group-hover:text-primary"><span
                                            ...
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                ...
                                                <path
                                                    d="M7.33333 4.58334C4.80203 4.58334 2.75 7.34609 2.75 10.1088C2.75 13.332 3.20833 15.6343 5.04167 18.3971C6.43541 20.264 8.29608 20.7321 10.2795 19.4245C10.7027 19.1454 11.2973 19.1454 11.7205 19.4245C13.7039 20.7321 15.5646 20.264 16.9583 18.3971C18.7917 15.6343 19.25 13.332 19.25 10.1088C19.25 7.34609 17.198 4.58334 14.6667 4.58334C13.36 4.58334 12.1811 5.30284 11.3462 6.07984C11.1522 6.26037 10.8478 6.26037 10.6538 6.07984C9.8189 5.30284 8.63997 4.58334 7.33333 4.58334Z"
                                                    stroke="#161C24" stroke-width="1.5" stroke-linejoin="round" />
                                                <path d="M5.5 11C5.5 9.50263 6.25417 8.00524 7.33333 7.33334"
                                                    stroke="#161C24" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M11 5.50001C11 4.27779 11.55 1.83334 13.75 1.83334"
                                                    stroke="#161C24" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg> </span>Fresh & Organic
                                        <span class="absolute right-0 top-1/2 -translate-y-1/2">
                                            <i
                                                class="hgi hgi-stroke hgi-arrow-right-01 text-lg text-light-primary-text"></i>
                                        </span>
                                    </a>
                                    <!-- First Drop Dwon -->
                                    <ul
                                        ...
                                        <li class="py-[9px] px-4 group/item">
                                            <a href="#"
                                                class="flex items-center gap-x-2 relative text-light-primary-text group-hover/item:text-primary">
                                                Sub Dropdown-1
                                                <span class="absolute right-0 top-1/2 -translate-y-1/2"><i
                                                        class="hgi hgi-stroke hgi-arrow-right-01 text-lg text-light-primary-text"></i>
                                                </span>
                                            </a>
                                            <!-- 2nd Drop Down -->
                                    ...
                                    <a href="#"
                                        class="flex items-center gap-x-2 relative text-light-primary-text group-hover:text-primary"><span
                                            ...
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                ...
                                                <path d="M13.2915 14.2083L11.9165 12.8333" stroke="#161C24"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M6.4165 10.0833L7.7915 11.4583" stroke="#161C24"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8.25016 17.4167L7.3335 16.5" stroke="#161C24"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                        ...
                                        class="flex items-center gap-x-2 relative text-light-primary-text group-hover:text-primary"><span
                                            ...
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    fill="#5ED9BA" />
                                                <path d="M5.50732 11L5.49909 11" stroke="#161C24" stroke-width="2"
                                        ...
                                        class="flex items-center gap-x-2 relative text-light-primary-text group-hover:text-primary"><span
                                            ...
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#161C24" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M13.2915 10.5417L13.2833 10.5417" stroke="#161C24"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                    d="M10.5415 6.41667C10.6943 6.72223 11.2748 7.33334 12.3748 7.33334"
                                                    stroke="#161C24" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M9.1665 10.0833L8.70817 10.5417" stroke="#161C24"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </span>
                                        Rice, Pulses
                                        ...
                                        class="flex items-center gap-x-2 relative text-light-primary-text group-hover:text-primary"><span
                                            ...
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                ...
                                                <path
                                                    d="M7.33333 4.58333C4.80203 4.58333 2.75 7.34607 2.75 10.1088C2.75 13.332 3.20833 15.6343 5.04167 18.397C6.43541 20.264 8.29608 20.7321 10.2795 19.4245C10.7027 19.1454 11.2973 19.1454 11.7205 19.4245C13.7039 20.7321 15.5646 20.264 16.9583 18.397C18.7917 15.6343 19.25 13.332 19.25 10.1088C19.25 7.34607 17.198 4.58333 14.6667 4.58333C13.36 4.58333 12.1811 5.30282 11.3462 6.07983C11.1522 6.26036 10.8478 6.26036 10.6538 6.07983C9.8189 5.30282 8.63997 4.58333 7.33333 4.58333Z"
                                                    stroke="#161C24" stroke-width="1.5" stroke-linejoin="round" />
                                                <path d="M5.5 11C5.5 9.50261 6.25417 8.00523 7.33333 7.33333"
                                                    stroke="#161C24" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M11 5.5C11 4.27778 11.55 1.83333 13.75 1.83333"
                                                    stroke="#161C24" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                        </span>
                                        ...
                                        class="flex items-center gap-x-2 relative text-light-primary-text group-hover:text-primary"><span
                                            ...
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    fill="#5ED9BA" />
                                                <circle cx="11.0002" cy="11" r="2.29167" fill="white" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    stroke="#161C24" stroke-width="1.5" stroke-linecap="round" />
                                                <path d="M4.5835 4.58333L17.4168 4.58333" stroke="#161C24"
                                                    stroke-width="1.5" />
                                                <path d="M4.5835 17.4167H17.4168" stroke="#161C24" stroke-width="1.5" />
                                                <path d="M5.5 1.83333L16.5 1.83333" stroke="#161C24" stroke-width="1.5"
                                                    stroke-linecap="round" />
                                                <circle cx="11.0002" cy="11" r="2.29167" stroke="#161C24"
                                                    stroke-width="1.5" />
                                            </svg>
                                        </span>
                                        Sauces, Pickels
                                        ...
                                        class="flex items-center gap-x-2 relative text-light-primary-text group-hover:text-primary"><span
                                            ...
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke-linejoin="round" />
                                                <path d="M8.70833 12.375V16.0417M10.5417 14.2083L6.875 14.2083"
                                                    stroke="#212529" stroke-width="1.5" stroke-linecap="round" />
                                                <path
