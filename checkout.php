                ...
                <div class="border border-gray-300 w-full payment-method px-3 py-4">
                  <div>
                    <label class="flex items-center gap-x-2 cursor-pointer">
                      ...
                      <!-- label text -->
                      <span class="text-light-primary-text">Razorpay</span>
                    </label>
                  </div>
            ...
            <table class="w-full cart-items-table">
              <tbody class="space-y-6">
                <tr>
                  <td class="py-4 px-4 product-thumbnail">
                    <div class="w-[60px] h-[60px] rounded-xl bg-[#F4F3F5] overflow-hidden">
                      <img src="assets/images/vitamin-c-2.png" alt="vitamin-c-2"
                    ...
                    <div class="flex flex-col gap-y-2">
                      ...
                      <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-x-1.5">
                          <span
                            class="line-through text-light-disabled-text font-normal product-total-price">$29.95</span>
                          <span class="text-primary font-semibold product-offer-price">$27.49</span>
                        </div>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  <td class="py-4 px-4 product-thumbnail">
                    <div class="w-[60px] h-[60px] rounded-xl bg-[#F4F3F5] overflow-hidden">
                      <img src="assets/images/temperature-gun-2.png" alt="temperature-gun-2"
                        class="w-full h-full object-cover rounded-xl" />
                    </div>
                  </td>
                  <td class="py-4 md:pr-4 pr-2 align-bottom w-full">
                ...
                <tr>
                  <td class="py-4 px-4 product-thumbnail">
                    <div class="w-[60px] h-[60px] rounded-xl bg-[#F4F3F5] overflow-hidden">
                      <img src="assets/images/bp-machine.png" alt="bp-machine"
                        class="w-full h-full object-cover rounded-xl" />
                    </div>
                  </td>
                  <td class="py-4 md:pr-4 pr-2 align-bottom w-full">
                ...
                <tr>
                  <td class="py-4 px-4 product-thumbnail">
                    <div class="w-[60px] h-[60px] rounded-xl bg-[#F4F3F5] overflow-hidden">
                      <img src="assets/images/bp-machine-2.png" alt="bp-machine-2"
                        class="w-full h-full object-cover rounded-xl" />
                    </div>
                  </td>
                  <td class="py-4 md:pr-4 pr-2 align-bottom w-full">
