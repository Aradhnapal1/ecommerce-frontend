...
<!-- ========== Home Category Sections Start ========== -->
<div id="home-category-sections"></div>
<!-- ========== Home Category Sections End ========== -->
...
<section class="pb-[70px]">
    <div class="container">
        <div class="flex lg:justify-between justify-center flex-wrap lg:flex-nowrap pb-12 wow animate__animated animate__fadeInUp"
            ...
            <a href="shop.php?hasDiscount=true" class="btn btn-primary outline btn-large py-2.5 px-10 rounded-full">
                View All
            </a>
        </div>
        <div id="top-discounted-products" class="grid grid-cols-12 gap-x-6 xl:gap-y-12 gap-y-6">
            <div class="col-span-12 text-center py-10 text-light-secondary-text">Loading products...</div>
        </div>
    </div>
</section>
