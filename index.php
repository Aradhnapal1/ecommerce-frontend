...
<section class="pb-[50px]">
    <div class="container">
        <div class="bg-[url(../images/home-5/countdown-bg.png)] lg:py-[70px] py-10 bg-cover rounded-5xl wow animate__animated animate__fadeInUp"
            data-wow-delay=".2s">
            <div class="flex items-center justify-center">
                <div class="md:bg-white bg-transparent text-center lg:p-[60px] p-10 rounded-5xl wow animate__animated animate__fadeInUp"
                    data-wow-delay=".3s">
                    <h2>Hurry! Limited Deals</h2>
                    <p class="pt-3 pb-10 text-light-primary-text">
                        Cases you love, prices you&apos;ll love more.
                    </p>
                    <div class="limited-deal-countdown flex flex-wrap md:flex-nowrap gap-3 pb-10 sellzy-countdown">
                        <div class="bg-[#9EE872] py-6 md:min-w-[140px] w-full rounded-2xl wow animate__animated animate__fadeInUp"
                            data-wow-delay=".3s">
                            <p>Days</p>
                            <h3 class="days">00</h3>
                        </div>
                        <div class="bg-[#FFEB69] py-6 md:min-w-[140px] w-full rounded-2xl wow animate__animated animate__fadeInUp"
                            data-wow-delay=".4s">
                            <p>Hours</p>
                            <h3 class="hours">00</h3>
                        </div>
                        <div class="bg-[#FFD6EF] py-6 md:min-w-[140px] w-full rounded-2xl wow animate__animated animate__fadeInUp"
                            data-wow-delay=".5s">
                            <p>Mins</p>
                            <h3 class="minutes">00</h3>
                        </div>
                        <div class="bg-[#A0E2E0] py-6 md:min-w-[140px] w-full rounded-2xl wow animate__animated animate__fadeInUp"
                            data-wow-delay=".6s">
                            <p>Secs</p>
                            <h3 class="seconds">00</h3>
                        </div>
                    </div>
                    <a class='btn btn-primary text-white font-semibold btn-large rounded-[60px] group py-2 pl-5 pr-3'
                        href='shop-left-sidebar-3col.html'>
                        Shop Now
                        <span
        ...
        <div class="grid grid-cols-12 gap-y-5 py-5">
            <div class="col-span-6 md:col-span-4 xl:col-span-2 mx-auto wow animate__animated animate__fadeInUp"
                data-wow-delay=".2s">
                <img src="assets/images/home-5/content-logo-1.png" alt="Ipsum Logo" />
            </div>
            <div class="col-span-6 md:col-span-4 xl:col-span-2 mx-auto wow animate__animated animate__fadeInUp"
                data-wow-delay=".3s">
                <img src="assets/images/home-5/content-logo-2.png" alt="Ipsum Logo" />
            </div>
            <div class="col-span-6 md:col-span-4 xl:col-span-2 mx-auto wow animate__animated animate__fadeInUp"
                data-wow-delay=".4s">
                <img src="assets/images/home-5/content-logo-3.png" alt="Ipsum Logo" />
            </div>
            <div class="col-span-6 md:col-span-4 xl:col-span-2 mx-auto wow animate__animated animate__fadeInUp"
                data-wow-delay=".5s">
                <img src="assets/images/home-5/content-logo-4.png" alt="Ipsum Logo" />
            </div>
            <div class="col-span-6 md:col-span-4 xl:col-span-2 mx-auto wow animate__animated animate__fadeInUp"
                data-wow-delay=".6s">
                <img src="assets/images/home-5/content-logo-5.png" alt="Ipsum Logo" />
            </div>
            <div class="col-span-6 md:col-span-4 xl:col-span-2 mx-auto wow animate__animated animate__fadeInUp"
                data-wow-delay=".7s">
                <img src="assets/images/home-5/content-logo-6.png" alt="Ipsum Logo" />
            </div>
        </div>
    </div>
</section>
            ...
            <div class="md:col-span-6 col-span-12 xl:col-span-3 wow animate__animated animate__fadeInUp"
                ...
                <div
                    ...
                    <div class="py-4 px-3 bg-[#9EE872] rounded-2xl">
                        ...
                        <a class='btn btn-primary text-white text-sm leading-6 font-semibold btn-large rounded-[60px] group py-1.5 pl-5 pr-3'
                            href='shop-left-sidebar-3col.html'>
                            See More Products
                            <span
                                class="size-8 bg-white inline-flex items-center justify-center rounded-full rotate-[-40deg] transform group-hover:rotate-0 transition-all duration-300">
...
<section class="pb-[70px]">
    <div class="container">
        <h3 class="pb-12 text-center wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
            Deals of the day
        </h3>

        <div data-slick='{"slidesToShow": 2, "slidesToScroll": 1, "loop": true, "arrows": false, "infinite": true, "dots": true, "autoplay": true, "autoplaySpeed": 7000, "responsive": [{"breakpoint": 1025, "settings": {"slidesToShow": 1}}]}'
            class="home-five-deal-of-the-day-slider -mx-3 sellzy-slider">
            <div class="single-slider-item px-3 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                <div class="flex flex-col md:flex-row border border-error rounded-3xl divide-x divide-gray-300">
                    <div class="product-image md:w-1/2 w-full p-6 max-h-[400px]">
                        <img src="assets/images/home-5/iphone-2.png" alt="Product 1"
                            class="w-full h-full object-cover rounded-2xl" />
                    </div>
                    <div class="px-6 py-[31px] md:w-1/2 w-full">
                        <span
                            class="product-discount-badge relative bg-error text-warning-lighter font-medium text-sm leading-[22px] px-1 after:absolute after:top-0 after:right-0 after:z-10 after:w-1 after:h-full after:bg-[url('images/discount-shape.html')] after:bg-contain">15%
                            OFF</span>
                        ...
                        <div class="variation-buttons flex gap-x-2.5 mb-4">
                            <div class="variation-color-item p-1 border border-gray-300 rounded-full">
                                <button data-color="#D0AEFF"
                                    class="size-6 bg-[#D0AEFF] rounded-full flex items-center justify-center cursor-pointer">
                                    <i class="hgi hgi-stroke hgi-tick-02 text-white hidden"></i>
                                </button>
                            </div>
                            <div class="variation-color-item p-1 border border-gray-300 rounded-full">
                                <button data-color="#5ED9BA"
                                    class="size-6 bg-[#5ED9BA] rounded-full flex items-center justify-center cursor-pointer">
                                    <i class="hgi hgi-stroke hgi-tick-02 text-white hidden"></i>
                                </button>
                            </div>
                            <div class="variation-color-item p-1 border border-gray-300 rounded-full">
                                <button data-color="#FFE16A"
                                    class="size-6 bg-[#FFE16A] rounded-full flex items-center justify-center cursor-pointer">
                                    <i class="hgi hgi-stroke hgi-tick-02 text-white hidden"></i>
                                </button>
                            </div>
                            <div class="variation-color-item p-1 border border-gray-300 rounded-full">
                                <button data-color="#74CAFF"
                                    class="size-6 bg-[#74CAFF] rounded-full flex items-center justify-center cursor-pointer">
                                    <i class="hgi hgi-stroke hgi-tick-02 text-white hidden"></i>
                                </button>
                            </div>
                            <div class="variation-color-item p-1 border border-gray-300 rounded-full">
                                <button data-color="#84A9FF"
                                    class="size-6 bg-[#84A9FF] rounded-full flex items-center justify-center cursor-pointer">
                                    <i class="hgi hgi-stroke hgi-tick-02 text-white hidden"></i>
                                </button>
                            </div>
                        </div>
                        <div class="home-five-deal-of-the-day-countdown flex items-center gap-2 mb-4 sellzy-countdown">
                            <div class="bg-gray-200 rounded-xl w-20 h-[60px] flex flex-col items-center justify-center">
                                <p class="text-xs leading-[18px] font-normal">Days</p>
                                <p class="text-sm leading-[22px] font-medium text-light-primary-text days">
                                    00
                                </p>
                            </div>
                            <div class="bg-gray-200 rounded-xl w-20 h-[60px] flex flex-col items-center justify-center">
                                <p class="text-xs leading-[18px] font-normal">Hours</p>
                                <p class="text-sm leading-[22px] font-medium text-light-primary-text hours">
                                    00
                                </p>
                            </div>
                            <div class="bg-gray-200 rounded-xl w-20 h-[60px] flex flex-col items-center justify-center">
                                <p class="text-xs leading-[18px] font-normal">Minutes</p>
                                <p class="text-sm leading-[22px] font-medium text-light-primary-text minutes">
                                    00
                                </p>
                            </div>
                            <div class="bg-gray-200 rounded-xl w-20 h-[60px] flex flex-col items-center justify-center">
                                <p class="text-xs leading-[18px] font-normal">Seconds</p>
                                <p class="text-sm leading-[22px] font-medium text-light-primary-text seconds">
                                    00
                                </p>
                            </div>
                        </div>
                        <div class="deal-progress flex flex-col gap-y-1 mb-4">
                            <div class="progress w-full h-1.5 bg-warning-lighter rounded-[50px] overflow-hidden">
                                <div style="width: 60%" class="progress-bar h-full bg-warning rounded-[50px]"></div>
                            </div>
                        ...
                        <div class="gap-x-2 flex items-center justify-between">
                            <div class="price-section flex items-center gap-x-3">
                                <span
                                    class="current-price text-lg leading-7 font-bold text-light-primary-text font-urbanist">$27.49</span>
                                <span
                                    class="old-price text-lg leading-7 font-semibold text-light-disabled-text line-through font-urbanist">$29.99</span>
                            </div>
                            <a class='btn btn-primary rounded-full font-semibold text-sm leading-6 py-1.5 px-[32.5px]'
                                href='cart-single-vendor.html'>
                                <span>
                                    <i class="hgi hgi-stroke hgi-shopping-cart-02 text-xl text-white"></i>
                                </span>
            ...
            <div class="single-slider-item px-3 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                <div class="flex flex-col md:flex-row border border-error rounded-3xl divide-x divide-gray-300">
                    <div class="product-image md:w-1/2 w-full p-6 max-h-[400px]">
                        <img src="assets/images/home-5/macbook.png" alt="Product 1"
                            class="w-full h-full object-cover rounded-2xl" />
                    </div>
                    <div class="px-6 py-[31px] md:w-1/2 w-full">
                        <span
            ...
            <div class="single-slider-item px-3 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                <div class="flex flex-col md:flex-row border border-error rounded-3xl divide-x divide-gray-300">
                    <div class="product-image md:w-1/2 w-full p-6 max-h-[400px]">
                        <img src="assets/images/home-5/iphone-2.png" alt="Product 1"
                            class="w-full h-full object-cover rounded-2xl" />
            ...
            <div class="single-slider-item px-3 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                <div class="flex flex-col md:flex-row border border-error rounded-3xl divide-x divide-gray-300">
                    <div class="product-image md:w-1/2 w-full p-6 max-h-[400px]">
                        <img src="assets/images/home-5/macbook.png" alt="Product 1"
                            class="w-full h-full object-cover rounded-2xl" />
...
<section class="pb-[70px]">
    <div class="container">
        <div class="grid grid-cols-12 gap-6">
            <div class="lg:col-span-6 col-span-12 xl:col-span-4 wow animate__animated animate__fadeInUp"
                data-wow-delay=".2s">
                <div
                    ...
                    <div>
                        ...
                        <a class='btn btn-primary text-white text-sm leading-6 font-semibold btn-large rounded-[60px] group py-2 pl-5 pr-3'
                            href='shop-left-sidebar-3col.html'>
                            Shop Now
                            <span
                                class="size-8 bg-white inline-flex items-center justify-center rounded-full rotate-[-40deg] transform group-hover:rotate-0 transition-all duration-300">
